<div>
    ...
    <x-slot name="head">
        @php
            // Obtener imagen del header de videos (intentar ambos identificadores posibles)
            $headerSettings = \App\Models\PageHeaderSetting::where('identifier', 'Videos_header')
                ->orWhere('identifier', 'videos_header')
                ->first();
