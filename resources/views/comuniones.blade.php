<x-app-layout>
    ...
    <x-slot name="head">
        @php
            // Obtener imagen del header de comuniones
            $headerSettings = \App\Models\PageHeaderSetting::where('identifier', 'Comuniones_header')->first();
        ...
        <meta name="classification" content="Fotografía de Comuniones, Primera Comunión, Fotografía Infantil">
        ...
        <script type="application/ld+json">
        {
            ...
            "description": "Foto Valera es un estudio fotográfico profesional en Almería con más de 23 años de experiencia especializado en fotografía de comuniones. Reportajes de primera comunión creativos y profesionales que capturan la inocencia y alegría de los niños en este día tan especial.",
            "address": {
                "@type": "PostalAddress",
                "streetAddress": "C. Alcalde Muñoz, 13",
                "addressLocality": "Almería",
